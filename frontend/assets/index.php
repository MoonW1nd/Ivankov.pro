...
<head>
    ...
    elseif (strpos($user_agent, "Safari") !== false) $browser = "css/safari.css";
...
<body>
<div id="preloader">
    <div class="loaderTxt">Alexander Ivankov <br>
        <span>&beta;-версия</span></div>
    <sup>&beta;</sup>
            ...
            <div class="ll">
                <div class="abouttext">
                    ...
                    <form class='aboutform'>
                        <a class="buttonDark" target="_blank" href="http://hh.ru/resume/269ff2c8ff03c00fb40039ed1f74394f706f34">Резюме</a>
                    </form>
    ...
    <section class="d">
        <div id="skill" class="wrapper">
            <div class="sk">
                ...
                <div class="skTxt"><p><span class="bld">Работаю с</span><br>Gulp, Git, AJAX, D3.js, Apache, Stylus, Sass, PhpStorm, SublimeText</p></div>
                <div class="skTxt"><p><span class="bld">Скорость "слепой" печати</span><br>Eng ~ 160 сим/мин, <br class="brTxt">Ru ~ 200 сим/мин</p></div>
                <div class="skTxt">
    ...
    <section class="d">
        <div class="wrapper portfolioMain">
            ...
            <div class="portfolioImg">
                <div class="works imgport_1"><div class="works_hide"> <div class="worksBorder">
                            <div class="portfolioImgName">Alexander Ivankoff Logo</div>
                            <a class="portfolioView">Посмотреть</a>
                        </div></div></div>
                <div class="works imgport_2"><div class="works_hide"> <div class="worksBorder">
                            <div class="portfolioImgName">Векторная графика</div>
                            <a class="portfolioView">Посмотреть</a>
                        </div></div></div>
                <div class="works imgport_3"><div class="works_hide"> <div class="worksBorder">
                            <div class="portfolioImgName">Промо страница "Граненый стакан"</div>
                            <a class="portfolioView">Посмотреть</a>
                        </div></div></div>
                <div class="works imgport_4"><div class="works_hide"> <div class="worksBorder">
                            <div class="portfolioImgName">Smoke Курьер <br> <span>Сайт по аренде кальянов</span></div>
                            <a class="portfolioView" href="http://smokecourier.ru/" target="_blank">Посмотреть</a>
                        </div></div></div>
                <div class="works imgport_5"><div class="works_hide"> <div class="worksBorder">
                            <div class="portfolioImgName">Eazy Breezy <br> <span>Сайт кальянной</span></div>
                            <a class="portfolioView">Посмотреть</a>
                        </div></div></div>
                <div class="works imgport_6"><div class="works_hide"> <div class="worksBorder">
                            <div class="portfolioImgName">Скоро здесь будет что-то интересное :)</div>
                            <!-- <a class="portfolioView">Посмотреть</a> -->
                        </div></div></div>
            </div>
        ...
        <footer class="wrapper">
            <div class="footerMain">
                <div class="footerContact">
                    <p class="contactTheme">Котакты</p>
                    <hr class="contactTheme" size="8" noshade="" color="#b02f19">
                    ...
                    <a href="https://www.instagram.com/moonw1nd/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i>&nbsp;&nbsp; MoonW1nd</a>	<br>
                    <a href="https://www.facebook.com/alexanderivankoff" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i>&nbsp;&nbsp; Александр Иванков</a>	<br>
                    <a href="https://vk.com/s.ivankoff" target="_blank"><i class="fa fa-vk" aria-hidden="true"></i>&nbsp; Sashka Ivankoff</a>
                </div>
